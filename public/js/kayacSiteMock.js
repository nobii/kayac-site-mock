...
(function setupNewsPage() {
    ...
    function loadNews() {
        _jquery2.default.ajax({ url: '/api/news.json', dataType: 'json' }).done(function (json) {
...
(function setupMemberPage() {
    ...
    function loadMember() {
        currentMemberPage++;
        _jquery2.default.ajax({ url: '/api/member.' + currentMemberPage + '.json', dataType: 'json' }).done(function (json) {
